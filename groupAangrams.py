# A very simple way to solve this is using dictionaries. Now, in python there is concept of default dictionary in which I have initialized the value to be in form of list
