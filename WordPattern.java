...
/*
Approach:Will have to keep in mind that we have to maintain 2 way relation thats why only mapping a character and string in a map is not going to work here.
Here we are generating patterns for both the strings and checking if they are matching or not).
...
public class WordPattern {
    ...
    public  static boolean wordPattern(String pattern, String str) {
        ...
        if (pattern.length() != strArr.length)
            return false;
     return generateCharPattern( pattern ).equals( generateStringPattern( strArr ) );
