...
// In the below solution to check isomorphic for string s and t, we will create 2 hashmaps for s and t. As we process each character of the string. We will put character from s as key and character from t as value in 
